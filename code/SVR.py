...
import os
os.chdir(r'C:\Users\uqstomur\OneDrive - The University of Queensland\Documents\Data\TeoNAM')

## Read data 
## Assume that each data has n lines(rows) & m-1 markers + 1 phenotype at the end(columns)
data_train = pd.read_csv('example_G3_train.csv')
data_test = pd.read_csv('example_G3_test.csv')
